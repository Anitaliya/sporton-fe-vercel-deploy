...
import { transactionCheckout } from "@/app/services/trasnsaction.service"
...
const PaymentSteps = () => {
    ...
    return (
        <CardWithHeader title="Payment Steps">
            <div className="p-5">
                <ol className="list-decimal text-xs pl-2 flex-col gap-4">
                    <li>
                    ...
                    <li>
                        ...
                        or a screenshot of the transfer confirmation. This will be
